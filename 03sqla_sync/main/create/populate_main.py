...
def populate_aditivo_nutritivo():
    ...
    # Estamos a criar a sessão antes, pois vamos inserir vários objetos
    ...
    # Perceba que estamos a executar o commit somente no final. Desta forma os 100 dados serão enviados em um único batch para o banco
    session.commit()
